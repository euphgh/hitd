...
public:
    ...
    void reset() {
        ...
        config1_reg->DA = 3; // Dcache associativity: 1: 2-way
        config1_reg->DL = 4; // Dcache line size: 5: 64bytes
        config1_reg->DS = 1; // Dcache sets per way: 0: 64
        config1_reg->IA = 3; // Icache associativity: 1: 2-way
        config1_reg->IL = 4; // Icache line size: 4: 64bytes
        config1_reg->IS = 1; // Icache sets per way: 0: 64
